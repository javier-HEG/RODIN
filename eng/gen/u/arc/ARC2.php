 ...
 * @package ARC2
 * 
 * Fabio Ricci (fabio.ricci@ggaweb.ch, tel. +41-76-5281961)
 * Small enhancements for use inside RODIN
 */

/* E_STRICT hack */

/* The following is to avoid redefinition and warning while including the class several times*/
