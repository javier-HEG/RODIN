...
$not_access=1;
$granted="I";
$pagename="portal/xmlnetwork_usernetwork.php";
//includes
...
if (!__networkIsPublic) exit('not allowed');

$DB->getResults($xmlnetworkusers_getUserById,$DB->escape($_GET['id']),$DB->escape($_GET['s']));
