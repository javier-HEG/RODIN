...
$not_access=1;
$granted="I";
$pagename="portal/xmlnetwork_usersnotebookgroup.php";
//includes
...
{
	$cle = $row["id"];
	$descriptions[$cle] = $row["description"]; 
}
$DB->freeResults();

$DB->getResults($xmlnetworkusers_getUsersByNotebook, $DB->escape($_GET["gid"]), $DB->escape($_SESSION['user_id']), $DB->escape($_SESSION['user_id']));
