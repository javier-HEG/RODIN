...
while (isset($_POST["plugi".$inc]))
{
	...
	else if ($_POST["plugi".$inc]=="1" && !isset($_POST["plug".$inc]) && array_search($_POST['link'.$inc],$PLUGINS)!==false)
	{
		$DB->execute($plugin_removePlugin,$DB->quote($_POST["name".$inc]));
	...
	// added plugins
	// New plugins
	if (array_key_exists('file'.$inc,$_POST)  && isset($_POST["plug".$inc]) && array_search($_POST['link'.$inc],$PLUGINS)===false && $_POST["plugi".$inc]=="0")
	{
		//register in the DB
	...
	// Old fashionned plugin
	}else if ($_POST["plugi".$inc]=="0" && isset($_POST["plug".$inc]) && array_search($_POST['link'.$inc],$PLUGINS)===false)
	{	
		//register in the DB
