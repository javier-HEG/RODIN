...
$isPortal=false;
$granted="A";
$pagename="admin/scr_cache_generate_all.php";
//includes
...
//update quantities of widgets by category
...
{
	header("location:scr_config_generate_configfiles.php?redirect=../install/generateplugins");
}
else
{
	header("location:scr_config_generate_configfiles.php?redirect=index");
}
*/
?>