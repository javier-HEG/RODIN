...
while ($row=$DB->fetch(0))
{
	...
	//echo "<link><![CDATA[".__LOCALFOLDER."notebook/detail_group.php?id=".$gid."&artid=".$row["id"]."]]></link>";
	echo '<link><![CDATA[javascript:$p.notebook.open('.$gid.',"group","'.$title.'",indef,'.$row['id'].')]]></link>';
