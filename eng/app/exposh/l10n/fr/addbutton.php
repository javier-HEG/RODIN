...
Ajouter un bouton sur votre site<br /><br />
<img src="../../images/addtoapplication.gif"><br /><br />
<textarea cols=60 rows=10>
<A href="<?php echo __LOCALFOLDER;?>portal/addtoapplication.php?pid=<?php echo $_GET["id"];?>" title="ajouter ce widget sur <?php echo __APPNAME;?>"><img src="<?php echo __LOCALFOLDER;?>images/addtoapplication.gif" alt="" style="border:0px" align=absmiddle /></A>
</textarea>
