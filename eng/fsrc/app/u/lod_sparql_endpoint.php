...
<form name='a' >
	...
	<br><span style="color:gray"> (Special function: PREFIX EXPRS + SUBTREE(ns:entity_id,n) displays a subgraphtree of depth n)</span>:</tr>
	<tr><td colspan=3><textarea style="width:100%;min-height:100px" name='QUERY'>$QUERY</textarea></tr>
