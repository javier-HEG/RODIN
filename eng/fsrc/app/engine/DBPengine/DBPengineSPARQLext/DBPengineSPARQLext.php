...
class DBPengineSPARQLext extends DBPengine 
{
...
#############################################
{
	...
	//Selektiere alles, was gebraucht wird, um einen Triple-"Einkauf" zu t�tigen:
	// B = broaders zu $term
	// N = narrower zo $term
...
EOQ;
	...
	// Berechne die Gewichtung von jedem Broaderterm und w�hle/liefere die ersten $m terme zur�ck
