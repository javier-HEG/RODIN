...
class SOZengine2 extends SOZengine
{
  ...
  protected $solr_collection;
	...
	#########################
	{
		...
		$this->currentclassname='SOZengine2';
  ...
  # Find Terme related to $action 
    ...
    global $RODINSEGMENT;
		...
		if ($this->getSrcDebug()) print "<br>SOZengine2->$METHODNAME($term)...";
...
{  
  ...
  else
  {
    ...
    if ($this->getVerbose())
		{
      print "<br>SOZengine2->get_stw_skos_nodes_SOLR($term,$descriptor,$m,$lang) ...";
    }
  ...
  if ($this->getSrcDebug())
    ...
    Logger::logAction(25, array('from'=>'SOZengine2->WebRefine','LOCALrootPATH'=>$LOCALrootPATH));
